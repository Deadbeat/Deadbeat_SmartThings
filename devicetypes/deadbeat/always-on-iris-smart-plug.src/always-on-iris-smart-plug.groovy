 ...
 *  Date: 2018-02-12
 *	Update off function and display colors to disable turning this switch off through any means other than physical
 */
metadata {
	// Automatically generated. Make future change here.
	definition (name: "Always On Iris Smart Plug", namespace: "deadbeat", author: "Nick Richardson") {
		capability "Actuator"
		capability "Switch"
...
//				attributeState "on", label: '${name}', action: "switch.off", icon: "st.switches.switch.on", backgroundColor: "#79b821", nextState: "on"
				attributeState "on", label: '${name}', action: "switch.off", icon: "st.switches.switch.on", backgroundColor: "#ffffff", nextState: "on"
