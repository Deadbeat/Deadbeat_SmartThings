...
metadata {
	definition (name: "SmartSense Motion Sensor Reduced Updates", namespace: "deadbeat", author: "Nick Richardson") {
...
def configure() {
    ...
    // Override temperature refresh rate to 30 minutes minimum and 1 hour max
    return refresh() + zigbee.batteryConfig() + zigbee.temperatureConfig(1800, 3600) // send refresh cmds as part of config
}
