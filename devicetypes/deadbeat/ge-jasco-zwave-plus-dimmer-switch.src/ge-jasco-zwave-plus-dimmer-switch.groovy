 ...
 *	Date: 04/19/2017
 *
 * 	Updated by: Nick Richardson (Deadbeat)
 * 	Date: 01-28-2018
 * 
 *	Changelog:
 *
 *  0.17 (01-28-2018) - Update z-wave level adjustments to use dim parameters, instead of jumping directly to level
...
def setLevel(value) {
    ...
    def p1 = device.currentValue("zwaveSteps")
    def p2 = device.currentValue("zwaveDelay")
    def p3 = level
